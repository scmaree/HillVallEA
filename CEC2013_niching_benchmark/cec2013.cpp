...
void CEC2013::load_goptima() 
{
	...
	std::string filename;
	if (nfunc_ == 1) {
		filename = "CEC2013_niching_benchmark/data/F1_opt.dat";
	} else if (nfunc_ == 2) {
		filename = "CEC2013_niching_benchmark/data/F2_opt.dat";
	} else if (nfunc_ == 3) {
		filename = "CEC2013_niching_benchmark/data/F3_opt.dat";
	} else if (nfunc_ == 4) {
		filename = "CEC2013_niching_benchmark/data/F4_opt.dat";
	} else if (nfunc_ == 5) {
		filename = "CEC2013_niching_benchmark/data/F5_opt.dat";
	} else if (nfunc_ == 6) {
		filename = "CEC2013_niching_benchmark/data/F6_2D_opt.dat";
	} else if (nfunc_ == 8) {
		filename = "CEC2013_niching_benchmark/data/F6_3D_opt.dat";
	} else if (nfunc_ == 7) {
		filename = "CEC2013_niching_benchmark/data/F7_2D_opt.dat";
	} else if (nfunc_ == 9) {
		filename = "CEC2013_niching_benchmark/data/F7_3D_opt.dat";
	} else if (nfunc_ == 10) {
		filename = "CEC2013_niching_benchmark/data/F8_2D_opt.dat";
	}
