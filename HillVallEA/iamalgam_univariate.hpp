...
namespace hillvallea
{
  ...
  class iamalgam_univariate_t : public optimizer_t
  {
  ...
  public: 
    ...
    // C++ Rule of Three
    //-------------------------------------------
    iamalgam_univariate_t(const size_t number_of_parameters, const vec_t & lower_param_bounds, const vec_t & upper_param_bounds, double init_univariate_bandwidth, fitness_pt fitness_function, rng_pt rng);
    ~iamalgam_univariate_t();
