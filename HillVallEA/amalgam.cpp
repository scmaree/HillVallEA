...
hillvallea::optimizer_pt hillvallea::amalgam_t::clone() const
{
  ...
  amalgam_pt opt = std::make_shared<amalgam_t>(number_of_parameters, lower_param_bounds, upper_param_bounds, init_univariate_bandwidth, fitness_function, rng);
...
void hillvallea::amalgam_t::initialize_from_population(population_pt pop)
{
  this->pop = pop;
