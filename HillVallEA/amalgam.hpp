...
namespace hillvallea
{
  ...
  class amalgam_t : public optimizer_t
  {
  ...
  public: 
    ...
    // C++ Rule of Three
    //-------------------------------------------
    amalgam_t(const size_t number_of_parameters, const vec_t & lower_param_bounds, const vec_t & upper_param_bounds, double init_univariate_bandwidth, fitness_pt fitness_function, rng_pt rng);
    ~amalgam_t();
    ...
    void update_distribution_multiplier(double & multiplier, const bool improvement, int & no_improvement_stretch, const double & sample_success_ratio, const double sdr) const;
